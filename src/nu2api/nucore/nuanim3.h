...
DECOMP_ASSERT(offsetof(nuanimdata2_s, node_count) == 0x04, "animation node count offset");
DECOMP_ASSERT(offsetof(nuanimdata2_s, curve_count) == 0x06, "animation curve count offset");
