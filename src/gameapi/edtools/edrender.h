...
extern "C" {
    ...
    void edbitsDrawCircleXY(NUVEC *centre, f32 radius, i32 colour, numtl_s *material);
    ...
    void edbitsDrawOvalTilted(NUVEC *centre, f32 radius_x, f32 radius_z, i32 colour, numtl_s *material, i32 rotation_z,
                              i32 rotation_y);
    void edbitsDrawTorus(NUVEC *centre, f32 radius, f32 radial_extent, f32 vertical_extent, i32 colour, numtl_s *material);
}
